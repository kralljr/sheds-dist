...
x <- matrix(rnorm(nrow(x) * ncol(x)), nrow = nrow(x))
```
...
set.seed(10)
y <- rpois(ny, exp(lmu))
m1 <- mcmcout(y, x, quants = quants1, niter = 25000, burnin = 0, thin = 1)
...
plot(m1b[, 1], m1ba, type = "l", ylim = c(-.3, 0.3), xlab = "Quantile", ylab = "Beta1")
