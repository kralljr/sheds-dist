...
set.seed(10)
y <- rpois(ny, exp(lmu))
m1 <- mcmcout(y, x, quants = quants1, niter = 20000, burnin = 0, thin = 1)
save(m1, file = "test_mcmc_largey.RData")
```
...
m1b <- data.frame(round(quants1, 2),  round(m1ba, 2))
...
plot(m1b[, 1], m1ba, type = "l", ylim = c(0.07, 0.13), xlab = "Quantile", ylab = "Beta1")
